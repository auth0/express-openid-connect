...
interface LoginOptions {
  /**
   *  URL to returnTo after logout, overrides the Default is {@link ConfigParams.routes.postLogoutRedirectUri routes.postLogoutRedirectUri}
   */
  returnTo?: string;
}
...
export namespace requiresAuth {
   ...
   *
   * ```js
   * const { requiresAuth: { claimCheck } } = require('express-openid-connect');
   *
