...
/**
 * Create OIDC client for a given issuer URL.
 * This is the core client creation logic used by both static and dynamic issuer flows.
 *
 * @param {string} issuerUrl - The issuer URL to discover
 * @param {Object} config - Application config
 * @returns {Promise<{client: Object, issuer: Object}>} Client and issuer metadata
 */
async function createClientForIssuer(issuerUrl, config) {
...
/**
 * Get OIDC client for static issuer configuration.
 * Wrapper around createClientForIssuer that uses config.issuerBaseURL.
 *
 * @param {Object} config - Application config with static issuerBaseURL
 * @returns {Promise<{client: Object, issuer: Object}>} Client and issuer metadata
 */
async function get(config) {
  return createClientForIssuer(config.issuerBaseURL, config);
}
...
// Export for use by IssuerManager (dynamic issuer resolution)
exports.createClientForIssuer = createClientForIssuer;
