...
async function refresh({ tokenEndpointParams } = {}) {
  ...
  if (config.tokenHistory) {
    TokenHistory.patchByAccessToken(req, oldTokenSet.access_token, newValues);
    ...
    if (newTokenSet.refresh_token) {
      TokenHistory.patchByRefreshToken(req, oldTokenSet.refresh_token, {
...
class ResponseContext {
  ...
  async callback(options = {}) {
    ...
    try {
      ...
      if (config.tokenHistory) {
        TokenHistory.append(req, session);
      }
