...
const paramsSchema = Joi.object().keys({
  ...
  // TODO: API.md update for all of the below and re-think names

  // TODO: validate for cookie name
  sessionName: Joi.string().optional().default('identity'),
  // TODO: default here will kill all sessions on server restart ... better to fail?
  sessionSecret: Joi.string().optional().default(crypto.randomBytes(20).toString('hex')),
  // TODO: think about default session length
  sessionLength: Joi.number().optional().default(7 * 24 * 60 * 60 * 1000),
