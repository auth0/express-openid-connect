 ...
 *
*/
module.exports.encryption = (secret) => hkdf(secret, BYTE_LENGTH, { info: ENCRYPTION_INFO, ...options });
module.exports.signing = (secret) => hkdf(secret, BYTE_LENGTH, { info: SIGNING_INFO, ...options });
