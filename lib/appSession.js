...
module.exports = (config) => {
  ...
  class CookieStore {
    async get(idOrVal) {
      ...
      switch (header.v) {
        // v2 => `{ s: <session>, t: <tokenHistory> }`
        case 2:
          return {
            header,
            data: parsedClearText.s,
            tokenHistory: parsedClearText.t,
          };
    ...
    async set(
      ...
      if (hasCurrentSession) {
        ...
        await this._set(req[REGENERATED_SESSION_ID] || id, {
          ...
          tokenHistory: TokenHistory.getAll(req),
          cookie: {
            expires: exp * 1000,
    ...
    try {
      ...
      if (existingSessionValue) {
        ...
        if (!sessionData || typeof sessionData !== 'object') {
          ...
          const { header, data, tokenHistory } = sessionData;
          ...
          if (!header || typeof header !== 'object') {
            ...
            TokenHistory.attach(req, tokenHistory || []);
            ...
            if (
              ...
              req[sessionName].id_token
            ) {
              TokenHistory.append(req, req[sessionName]);
            }
          }
        }
      }
