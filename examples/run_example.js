...
if (!process.env.CLIENT_ID) {
  ...
  // The hri example uses its own registered client that supports private_key_jwt + JAR + PAR.
  // All other examples use the default client.
  const clientId = example === 'hri.js'
    ? 'hri-client'
